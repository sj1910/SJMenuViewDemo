...
@interface SJMenuCell : UITableViewCell
@property (nonatomic,assign) BOOL         isShowSeparator;
@property (nonatomic,strong) UIColor    * separatorColor;
@end
@implementation SJMenuCell
...
@interface SJMenuAction()
@property (nonatomic) NSString      *title;
@property (nonatomic) UIImage       *image;
@property (copy, nonatomic)void (^handler)(SJMenuAction *);
@end
@implementation SJMenuAction
+ (instancetype)actionWithTitle:(NSString *)title image:(UIImage *)image handler:(void (^)(SJMenuAction *))handler{
    SJMenuAction *action = [[SJMenuAction alloc] initWithTitle:title image:image handler:handler];
    return action;
}
- (instancetype)initWithTitle:(NSString *)title image:(UIImage *)image handler:(void (^)(SJMenuAction *))handler{
    if (self = [super init]) {
        _title = title;
        _image = image;
...
@interface SJMenuView()<UITableViewDelegate,UITableViewDataSource>
{
    CGPoint          _refPoint;
    UIView          *_refView;
    CGFloat          _menuWidth;
...
@property(nonatomic,copy) NSArray<SJMenuAction *>   *actions;
...
static NSString *const menuCellID = @"SJMenuCell";
@implementation SJMenuView
...
+ (instancetype)menuWithActions:(NSArray<SJMenuAction *> *)actions width:(CGFloat)width atPoint:(CGPoint)point{
    ...
    SJMenuView *menu = [[SJMenuView alloc] initWithActions:actions width:width atPoint:point];
    return menu;
}
+ (instancetype)menuWithActions:(NSArray<SJMenuAction *> *)actions width:(CGFloat)width relyonView:(id)view{
    ...
    SJMenuView *menu = [[SJMenuView alloc] initWithActions:actions width:width relyonView:view];
    return menu;
}

- (instancetype)initWithActions:(NSArray<SJMenuAction *> *)actions width:(CGFloat)width atPoint:(CGPoint)point{
    if (self = [super init]) {
...
- (instancetype)initWithActions:(NSArray<SJMenuAction *> *)actions width:(CGFloat)width relyonView:(id)view{
    if (self = [super init]) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    SJMenuCell *cell = [tableView dequeueReusableCellWithIdentifier:menuCellID forIndexPath:indexPath];
    SJMenuAction *action = _actions[indexPath.row];
...
- (UITableView *)tableView{
    if (!_tableView) {
        ...
        [_tableView registerClass:[SJMenuCell class] forCellReuseIdentifier:menuCellID];
    }
    return _tableView;
}
- (UIView *)bgView{
